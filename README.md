...
Задача эксперимента: проверить, помогает ли temporal-контекст при детекции автомобилей на видео.
...
Полные изображения, видео и веса не включены в export. Список локальных файлов указан в:

```text
large_files_manifest.md
```

Для публикации этих файлов нужен Git LFS, GitHub Releases или внешнее хранилище.
